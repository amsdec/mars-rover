...
import com.github.amsdec.katas.mars_rover.es.EsRover;

public class EsMarsRoverTest {

    @Test(expected = InvalidCommandException.class)
    public void comandoDesconocido() {
        final Rover rover = new EsRover(new RoverStatus(new Position(0, 0), "N"), new Planet(5, 5, null));
        rover.execute("P");
    }
    ...
    public void girarAlEsteEstandoOrientadoAlNorte() {
        final Rover rover = new EsRover(new RoverStatus(new Position(1, 1), "N"), new Planet(5, 5, null));
    ...
    public void girarAlEsteEstandoOrientadoAlSur() {
        final Rover rover = new EsRover(new RoverStatus(new Position(0, 0), "S"), new Planet(5, 5, null));
        final RoverStatus status = rover.execute("I");
    ...
    public void girarAlOesteEstandoOrientadoAlSur() {
        final Rover rover = new EsRover(new RoverStatus(new Position(1, 1), "S"), new Planet(5, 5, null));
        final RoverStatus status = rover.execute("D");
    ...
    public void girarAlNorteEstandoOrientadoAlEste() {
        final Rover rover = new EsRover(new RoverStatus(new Position(0, 0), "E"), new Planet(5, 5, null));
        final RoverStatus status = rover.execute("I");
    ...
    public void girarAlSurEstandoOrientadoAlEste() {
        final Rover rover = new EsRover(new RoverStatus(new Position(1, 1), "E"), new Planet(5, 5, null));
        final RoverStatus status = rover.execute("D");
    ...
    public void girarAlSurEstandoOrientadoAlOeste() {
        final Rover rover = new EsRover(new RoverStatus(new Position(0, 0), "O"), new Planet(5, 5, null));
        final RoverStatus status = rover.execute("I");
    ...
    public void girarAlNorteEstandoOrientadoAlOeste() {
        final Rover rover = new EsRover(new RoverStatus(new Position(1, 1), "O"), new Planet(5, 5, null));
        final RoverStatus status = rover.execute("D");
    ...
    public void caminarUnaCasillaEstandoOrientadoAlNorte() {
        final Rover rover = new EsRover(new RoverStatus(new Position(3, 3), "N"), new Planet(5, 5, null));
    ...
    public void caminarUnaCasillaEstandoOrientadoAlSur() {
        final Rover rover = new EsRover(new RoverStatus(new Position(3, 3), "S"), new Planet(5, 5, null));
        final RoverStatus status = rover.execute("A");
    ...
    public void caminarUnaCasillaEstandoOrientadoAlEste() {
        final Rover rover = new EsRover(new RoverStatus(new Position(3, 3), "E"), new Planet(5, 5, null));
        final RoverStatus status = rover.execute("A");
    ...
    public void caminarUnaCasillaEstandoOrientadoAlOeste() {
        final Rover rover = new EsRover(new RoverStatus(new Position(3, 3), "O"), new Planet(5, 5, null));
        final RoverStatus status = rover.execute("A");
    ...
    public void pararAlTenerUnObstaculoLlendoAlNorte() {
        final Rover rover = new EsRover(new RoverStatus(new Position(0, 0), "N"),
    ...
    public void pararAlTenerUnObstaculoLlendoAlSur() {
        final Rover rover = new EsRover(new RoverStatus(new Position(0, 0), "S"),
                new Planet(5, 5, Arrays.asList(new Position(0, 2))));
        final RoverStatus status = rover.execute("AAAAAA");
    ...
    public void pararAlTenerUnObstaculoLlendoAlEste() {
        final Rover rover = new EsRover(new RoverStatus(new Position(0, 0), "E"),
    ...
    public void pararAlTenerUnObstaculoLlendoAlOeste() {
        final Rover rover = new EsRover(new RoverStatus(new Position(0, 0), "O"),
    ...
    public void pararAlTenerUnObstaculoLlendoAlNorte2() {
        final Rover rover = new EsRover(new RoverStatus(new Position(0, 2), "N"),
